...
function emailFrom(company) {
  var cofounder = company.cofounder || {name: 'cofounder'};
  return `${util.slugify(cofounder.name)}@${util.slugify(company.name)}.com`;
}
